(function () {
    ...
    function handler(btn) {
        ...
        if (btn !== 'C' && result === 'Result is undefined' 
        ...
        if (!isNaN(btn) || btn === '.') {
            ...
            if (btn === '=') {
                ...
                if (mathOp) {
                    mathOpCount = 0;
                    // if last button pressed is `mathOperation` like `+, - etc.` before `=` was pressed
                    if (mathOpPress) {
                        mathOp(prevResult);
            ...
            // count math ops if sign was pressed and prev btn isn't sign and except some buttons
    ...
    function updateMainScreen(val) {
        ...
        if (temp.length > 10) {
            ...
            temp = Math.round(temp * 10000000000000000) / 10000000000000000;
        }

        mainScreen.value = isNaN(temp) ? String(val) : temp;
    }
